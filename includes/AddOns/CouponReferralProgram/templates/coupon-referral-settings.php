...
<div class="bswp__text">
	...
	<input type="text" id="coupon_referral_email_subject" name="coupon_referral_email_subject" placeholder="Save today with this coupon code" value="<?php echo esc_attr( $subject ); ?>" />
</div>
...
<div class="bswp__textarea">
	...
	<textarea type="text" id="coupon_referral_email_content" name="coupon_referral_email_content" placeholder="Use the {{link}} to save!"><?php echo esc_textarea( $content ); ?></textarea>
</div>
